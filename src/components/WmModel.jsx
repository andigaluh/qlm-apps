    ...
    const columns = [
        ...
        },
        {
            ...
            cell: (row) => {
                return (
                    <React.Fragment>
                        <Link to={`/wm-model/form/${row.id}`} title="Detail">
        ...
        <Container className={classes.container}>
            <ToolsContext.Provider value={value}>
                ...
                {((!user.roles.includes("ROLE_ADMIN"))) ? (
                    ...
                    <React.Fragment>
                        <Typography variant="h4" className={classes.title}>Washing Machine Model</Typography>
                        <Card>
                            <CardContent>
