    ...
    const columns = [
        ...
        },
        {
            ...
            cell: (row) => {
                return (
                    <React.Fragment>
                        <Link to={`/outgoing/form/${row.id}`} title="Detail">
    ...
    return (
        <Container className={classes.container} maxWidth="xl">
            <ToolsContext.Provider value={value}>
                ...
                <React.Fragment>
                    <Typography variant="h4" className={classes.title}>Sample Outgoing</Typography>
                    <Card>
                        <CardContent>
                            <FormSearchDate
