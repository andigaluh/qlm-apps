...
const FormDailyReportAdminDraft = () => {
    ...
    const updateItem = (id, values, setSubmitting) => {
        ...
        setTimeout(() => {
            let data = new FormData();
            data.append("file", values.draft_file_name);
            daily_reportService.updateDraft(id, data)
                .then(
                    (response) => {
            ...
            {!user.roles.includes("ROLE_ADMIN") ? (
                ...
                <React.Fragment>
                    <div className={classes.titleContainer}>
                        ...
                        <Typography variant="h4" className={classes.title}>Upload Draft Daily report's Form</Typography>
                    </div>
                    <Card>
                        <CardContent>
                            <Formik
...
export default FormDailyReportAdminDraft;