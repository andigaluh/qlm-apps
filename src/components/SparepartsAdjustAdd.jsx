import { Card, CardContent, Fab, makeStyles, Snackbar, Tooltip, Typography } from "@material-ui/core";
...
const SparepartsAdjustAdd = () => {
    ...
    const retriveList = (id) => {
        parts_adjustment_itemService.getByPartsId(id).then(
            (response) => {
    ...
    return (
        <React.Fragment>
            <Card>
                <CardContent>
                    <Typography variant="h6" className={classes.title}>Stock Addition History</Typography>
...
export default SparepartsAdjustAdd;