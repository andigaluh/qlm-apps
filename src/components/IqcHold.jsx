...
const IqcHold = () => {
    ...
    const retrieveItem = () => {
        ...
        iqcService.getAllHold(params).then(
            (response) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            cell: (row) => {
                return (
                    <React.Fragment>
                        <Link to={`/iqc-hold/form/${row.id}`} title="Detail">
    ...
    return (
        <Container className={classes.container} maxWidth="xl">
            <ToolsContext.Provider value={value}>
                ...
                <React.Fragment>
                    <Typography variant="h4" className={classes.title}>Hold List Incoming</Typography>
                    <Card>
                        <CardContent>
                            <FormSearchDate
