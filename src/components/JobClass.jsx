...
const JobClass = () => {
    ...
    const columns = [
        ...
        {
            name: "Upper Job Class",
            selector: (row) => (row.upper_job_class) ? row.upper_job_class.name : "",
            sortable: true,
        },
        {
            name: "Action",
            cell: (row) => {
                return (
                    <React.Fragment>
                        <Link to={`/job/class/form/${row.id}`} title="Detail">
                        ...
                        <IconButton color="primary" title="Delete" aria-label="Delete" onClick={() => {
                            ...
                            if (r == true) {
                                job_classService.remove(row.id)
                                    .then((response) => {
                                        setOpen(true);
