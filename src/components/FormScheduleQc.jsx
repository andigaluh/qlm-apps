                                        ...
                                        <Grid container spacing={2}>
                                            <Grid item xs={12}>
                                                <div className={classes.item}>
                                                        <TextField select label="Machine" {...formik.getFieldProps('supplier_id')} fullWidth onClick={handleOnChangeSupplier}>
                                                        {currentSupplier &&
